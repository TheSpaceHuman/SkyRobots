                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-12">
                                    <div class="page-header-title">
                                        <div class="d-inline">
                                            <h5>Dashboard</h5>
                                            <span>Приборная панель со статистикой</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="latest-update-box">
                                                                <div class="row p-t-20 p-b-30">
                                                                    <div class="col-auto text-right update-meta p-r-0">
                                                                        <img src="/admin/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15 update-icon">
                                                                    </div>
                                                                    <div class="col p-l-5">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover m-b-0">
                                                                ...
                                                                <tr>
                                                                    <td>Sofa</td>
                                                                    <td>#PHD001</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d1b0b3b291b6bcb0b8bdffb2bebc">[email&#160;protected]</a></td>
                                                                ...
                                                                <tr>
                                                                    <td>Computer</td>
                                                                    <td>#PHD002</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d4b7b0b794b3b9b5bdb8fab7bbb9">[email&#160;protected]</a></td>
                                                                ...
                                                                <tr>
                                                                    <td>Mobile</td>
                                                                    <td>#PHD003</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d7d7c7f4d6a606c6461236e6260">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-danger">Out Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                ...
                                                                <tr>
                                                                    <td>Coat</td>
                                                                    <td>#PHD004</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fc9e9f8fbc9b919d9590d29f9391">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-success">In Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                ...
                                                                <tr>
                                                                    <td>Watch</td>
                                                                    <td>#PHD005</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4023242300272d21292c6e232f2d">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-success">In Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                ...
                                                                <tr>
                                                                    <td>Shoes</td>
                                                                    <td>#PHD006</td>
                                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6919181b290e04080005470a0604">[email&#160;protected]</a></td>
                                                                    <td><label class="label label-danger">Out Stock</label></td>
                                                                    <td>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
                                                                        <a href="#!"><i class="fa fa-star f-12 text-c-yellow"></i></a>
